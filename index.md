...
hero:
  name: "Micro Scaff"
  text: ""
  tagline: "工具沉淀 · 工程模板 · 服务端实践 · AI Agent"
  image: /logo.png
  actions:
    - theme: brand
      text: 🚀 Micro Tools
...
features:
  - title: 🛠 Micro Tools
    details: 沉淀常用工具函数、组件能力、请求封装和工程配置，把重复代码整理成可复用资产。
  - title: 📖 Learn
    details: 记录框架实践、问题排查、源码阅读和日常学习，把零散经验整理成可检索文档。
  - title: 🏗 项目基础搭建
    details: 基于 micro-tools 继续封装项目模板、目录规范、脚手架流程和基础工程能力。
  - title: 🧩 Golang 服务端
    details: 梳理 Go 服务端开发、接口设计、配置管理、数据库、部署和运维相关实践。
  - title: 🔌 扩展能力
    details: 收集插件化、自动化、跨端集成、效率工具和更多可组合的扩展方案。
  - title: 🤖 AI Agent
    details: 后续会补充 Agent 工作流、工具调用、自动化协作和智能研发相关实践。
  - title: 🌱 持续演进
    details: 当前先聚合 micro-tools 与 learn，后续会按模块逐步补齐完整知识版图。
...
- **Micro Tools**：前端工具、组件、请求封装、工程配置和通用能力。
- **Learn**：学习笔记、框架实践、问题记录和知识整理。
- **后续规划**：项目基础搭建、Golang 服务端、扩展能力、AI Agent 会陆续纳入同一套文档体系。

## 建设目标

- **可复用**：把重复出现的代码、配置和流程抽出来，形成稳定资产。
- **可追溯**：每一次问题排查、方案选择和实践经验都能回到文档里。
- **可扩展**：从前端工具逐步扩展到项目模板、服务端、自动化和 AI Agent 能力。
- **可维护**：内容按模块沉淀，后续新增目录时首页仍然能自然承接。
